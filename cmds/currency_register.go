...
func (fl *CurrencyFixedFeeerFlags) IsValid([]byte) error {
	...
	fl.feeer = currency.NewFixedFeeer(receiver, fl.Amount.Big, fl.ExchangeMinAmount.Big)
...
func (fl *CurrencyRatioFeeerFlags) IsValid([]byte) error {
	...
	fl.feeer = currency.NewRatioFeeer(receiver, fl.Ratio, fl.Min.Big, fl.Max.Big, fl.ExchangeMinAmount.Big)
	return fl.feeer.IsValid(nil)
}
...
func (fl *CurrencyDesignFlags) IsValid([]byte) error {
	...
	am := mitumcurrency.NewAmount(fl.GenesisAmount.Big, fl.Currency.CID)

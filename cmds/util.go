...
func POperationProcessorsMap(ctx context.Context) (context.Context, error) {
	...
	opr.SetProcessor(sto.RedeemTokensHint, sto.NewRedeemTokensProcessor())
	...
	opr.SetProcessor(kyc.RemoveControllersHint, kyc.NewRemoveControllersProcessor())
	opr.SetProcessor(kyc.AddCustomersHint, kyc.NewAddCustomersProcessor())
	opr.SetProcessor(kyc.UpdateCustomersHint, kyc.NewUpdateCustomersProcessor())
	...
	_ = set.Add(sto.RedeemTokensHint, func(height base.Height) (base.OperationProcessor, error) {
		return opr.New(
			height,
			db.State,
			nil,
	...
	_ = set.Add(sto.AuthorizeOperatorsHint, func(height base.Height) (base.OperationProcessor, error) {
		return opr.New(
			height,
			db.State,
			nil,
	...
	_ = set.Add(sto.RevokeOperatorsHint, func(height base.Height) (base.OperationProcessor, error) {
		return opr.New(
			height,
			db.State,
			nil,
	...
	_ = set.Add(kyc.AddCustomersHint, func(height base.Height) (base.OperationProcessor, error) {
		return opr.New(
			height,
			db.State,
			nil,
	...
	_ = set.Add(kyc.UpdateCustomersHint, func(height base.Height) (base.OperationProcessor, error) {
		return opr.New(
			height,
			db.State,
			nil,

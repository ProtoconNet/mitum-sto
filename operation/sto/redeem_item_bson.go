...
func (it RedeemItem) MarshalBSON() ([]byte, error) {
...
type RedeemItemBSONUnmarshaler struct {
...
func (it *RedeemItem) DecodeBSON(b []byte, enc *bsonenc.Encoder) error {
	e := util.StringError("failed to decode bson of RedeemItem")

	var uit RedeemItemBSONUnmarshaler

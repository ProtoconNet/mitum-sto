...
func (fact IssueSecurityTokensFact) MarshalBSON() ([]byte, error) {
...
type IssueSecurityTokensFactBSONUnmarshaler struct {
...
func (op IssueSecurityTokens) MarshalBSON() ([]byte, error) {
	return bsonenc.Marshal(
		bson.M{
